...
habitat_plot <- plot_model(habitat, type = "pred", terms = c("position_in_range [all]", "Habitat"), title = '') + ylab("") + xlab("") + scale_fill_manual(name = "Habitat type", values = c("#0072B2", "[...]")
...
larval_plot <- plot_model(larval_habitat, type = "int", terms = c("position_in_range [all]", "PlaceofDevelopment"), title = '') + ylab("") + xlab("") + scale_fill_manual(name = "Habitat type", values [...]
